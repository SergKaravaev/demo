package com.example.demoTwo.controller.swagger;
...
public interface EmployeeControllerDocumentation {
    ...
    ResponseEntity<Void> createEmployee(EmployeeRequestDto employeeRequestDto);
    ...
    ResponseEntity<Void> updateEmployee(UUID employeeId, EmployeeRequestDto employeeRequestDto);
